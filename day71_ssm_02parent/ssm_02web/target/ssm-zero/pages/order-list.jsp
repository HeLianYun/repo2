                ...
                <div class="box-footer">
                    ...
                    <script type="text/javascript">
                        ...
                        function submitPageNum(pageNum) {
                            //    发送请求
                            location.href = "${pageContext.request.contextPath}/order/findPage.do?pageNum=" + pageNum;
                        }

                        //提交数据
                        function submitPageSize(obj) {
                            //obj值得this，之选中的option对象
                            //发送那个请求
                            location.href = "${pageContext.request.contextPath}/order/findPage.do?pageSize=" + obj.value;
                        }
                    </script>
